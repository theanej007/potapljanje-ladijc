...
function flipColors(){
    ...
    for(let i = 0;i < 10;i++){
        ...
        document.getElementById("d"+(String.fromCharCode(i+65))).style.backgroundColor = color;
    }
    document.getElementById("d0").style.backgroundColor = color;
    document.getElementById("main_c").style.backgroundColor = color;
}
